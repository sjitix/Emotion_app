...
General outline:Reflectify is a journaling web application that analyzes the emotional content of user
...
Data storage:All journal entries are stored in google sheets.We created a google cloud service account
...
Design summary:the app uses streamlit's sidebar to create a navigation menu where users can switch
